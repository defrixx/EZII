...
def test_refresh_rejects_host_only_when_origin_is_missing(monkeypatch):
    from app.api.v1 import auth as auth_module
...
def test_refresh_accepts_same_host_only_when_host_is_trusted(monkeypatch):
    from app.api.v1 import auth as auth_module

    monkeypatch.setattr(auth_module, "TRUSTED_ORIGINS", {"http://localhost"})
