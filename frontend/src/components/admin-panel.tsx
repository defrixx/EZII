...
export function AdminPanel() {
  ...
  const [sourceImpactOpen, setSourceImpactOpen] = useState(false);
  ...
  return (
    <div className="safe-x safe-top safe-bottom min-h-screen bg-slate-50">
      <div className="mx-auto max-w-6xl space-y-4 p-3 pb-8 md:p-6">
                ...
                <div className="grid gap-3 md:grid-cols-[1.2fr_1fr_1fr_auto] md:items-end">
                  <label className="text-sm">
                    ...
                    <input
                      ...
                      className="sr-only"
                    />
                    <div className="flex items-center gap-2 rounded border border-slate-300 bg-white px-3 py-2 text-sm">
                      <button
                        type="button"
                      ...
                      <span className="truncate text-slate-600" title={documentFile?.name || "No file selected"}>
        ...
        <section className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
            title="Source Impact Analytics"
            subtitle="Usage trends for knowledge sources based on recent response traces."
            isOpen={sourceImpactOpen}
        ...
        <section className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
            ...
            subtitle="Global provider, retrieval, and response behavior that affects all chats."
        ...
        <section className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
            title="User Limits"
            subtitle="Controls message quotas and conversational context limits for the user role."
        ...
        <section className="rounded-2xl border border-red-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
        ...
        <section className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
            ...
            subtitle="Quick operational snapshot of the latest model responses and context usage."
        ...
        <section className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm md:p-5">
          <SectionToggleHeader
            ...
            subtitle="Latest backend failures for fast triage and incident follow-up."
            ...
            <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
              <label className="text-sm">
                ...
                <div className="flex items-center gap-2 rounded border border-slate-300 bg-white px-3 py-2 text-sm">
                  ...
                  <span className="truncate text-slate-600" title={glossaryImportFile?.name || "No file selected"}>
                    {glossaryImportFile?.name || "No file selected"}
                  </span>
                </div>
              </label>
              <p className="mt-2 text-xs text-slate-500">
